...
- If enough nations have a standard time, international time zones and the Prime Meridian can be introduced. It's possible that this won't be Greenwich.
...
- Cricket is invented from the beginning, the motherland is the UK. It will only spread via subjects and bloc members.
...
- New action for geologist: Uranium Expedition. Send your geologist on a worldwide search for uranium. After five years, he will establish a mine in a uranium state. However, you need to do your own treaty to import that uranium to your nation.
