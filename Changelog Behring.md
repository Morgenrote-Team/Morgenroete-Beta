...
- Trick or Treatment: Obtain a treatment for all ten epidemic diseases.
- John Slow: Be the first nation to find a treatment against cholera.
...
- Added Swedish Anthropologists, Archaeologists, Astronomers, Chemists, Geologists, Naturalists, and Paelontologists.
...
- Documented animals are now displayed in the tooltip below.
...
- Fixed various literature related events without a scope.
